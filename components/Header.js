  ...
  return (
    <div className="sticky z-50 flex h-16 bg-white items-center p-2 shadow-md top-0">
      ...
      <div className="flex min-w-fit">
        <Image
          src="https://cdn1.vectorstock.com/i/1000x1000/30/10/logo-book-in-the-form-of-a-cap-for-college-vector-5173010.jpg"
          height={40}
          width={40}
        />
        <div className="flex items-center space-x-2 px-2 ml-2 rounded-full bg-gray-100 text-gray-500">
          ...
          <input
            ...
            type="text"
            placeholder="Search College Media"
          />
        </div>
      </div>
      ...
      <div className="flex flex-grow justify-center mx-2">
        <div className="flex items-center">
          <div className="flex items-center  h-14 px-4 md:px-10 rounded-md md:hover:bg-gray-100 cursor-pointer ">
            <HiOutlineHome className="mx-auto text-indigo-900" size={25} />
          </div>
          <div className="flex items-center h-14 px-4 md:px-10 rounded-md md:hover:bg-gray-100 cursor-pointer ">
